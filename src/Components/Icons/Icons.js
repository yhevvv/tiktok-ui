...
export const FacebokIcon = ({ className, width, height }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const OpenEye = ({ className, width = '2.4rem', height = '2.4rem' }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 20 20"
...
export const Write = ({ className, width = '2rem', height = '2rem' }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 20 20"
...
export const Share = ({ className, width = '2.4rem', height = '2.4rem' }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const Lock = ({ className, width = '1.8rem', height = '1.9rem' }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const UserIconLager = ({ className, width, height }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const TickCheck = ({ className, width, height }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const Dot = ({ className, width = '2.4rem', height = '2.4rem' }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const Flag = ({ className, width = '1.6rem', height = '1.6rem' }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const Stop = ({ className, width = '1.6rem', height = '1.6rem' }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 16 16"
...
export const Send = ({ className, width = '1.6rem', height = '1.6rem' }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const ICircle = ({ className, width = '1.6rem', height = '1.6rem' }) => (
    <svg
        className={className}
        width={width}
        height={height}
